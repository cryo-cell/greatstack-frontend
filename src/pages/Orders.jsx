      ...
      <div>
        {
          orderData.map((item, index)=>(
            <div key={index} className='py-4 borderr-t border-b text-gray-700 flex flex-col md:flex-row md:items-center justify-between gap-3'>
